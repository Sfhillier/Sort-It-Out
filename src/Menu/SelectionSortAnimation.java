...
public class SelectionSortAnimation extends JPanel {
    ...
    // Amount to move down from top of node so that the text
    // displays in the correct location
    private static final int NODE_BUFFER = 35;
    private static final int NODE_WIDTH = 50;
    int x=150, x1=150, x2=150, x3=150, x4=150;   
    int y=100, y1=100, y2=100, y3=100, y4=100;
    int delay = 1000;
    boolean sortedNode, sortedNode1, sortedNode2, sortedNode3, sortedNode4;
	...
	public void paintComponent(Graphics g){
		...
		//create our nodes.
		Shape ellipse = new Ellipse2D.Double(x-100, y, NODE_WIDTH, NODE_WIDTH);
		Shape ellipse1 = new Ellipse2D.Double(x1-NODE_WIDTH, y1, NODE_WIDTH, NODE_WIDTH);
		Shape ellipse2 = new Ellipse2D.Double(x2, y2, NODE_WIDTH, NODE_WIDTH);
		Shape ellipse3 = new Ellipse2D.Double(x3+NODE_WIDTH, y3, NODE_WIDTH, NODE_WIDTH);
		Shape ellipse4 = new Ellipse2D.Double(x4+100, y4, NODE_WIDTH, NODE_WIDTH);
		...
		g2.setFont(font);
		g2.drawString("5", x-83, y+NODE_BUFFER);
		g2.drawString("1", x1-33, y1+NODE_BUFFER);
		g2.drawString("4", x2+17, y2+NODE_BUFFER);
		g2.drawString("2", x3+67, y3+NODE_BUFFER);
		g2.drawString("8", x4+117, y4+NODE_BUFFER);
	...
	public static void main(String[] args) {
		...
		SelectionSortAnimation s = new SelectionSortAnimation();
		JFrame f = new JFrame();
		f.add(s);
		f.setVisible(true);
		f.setSize(450,600);
